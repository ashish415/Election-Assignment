...
public class Data 
{
			...
			public void processData() throws IOException
			{
				...
				Data regioncontestent1=rr1.readRegions(1);
				Data regioncontestent2=rr2.readRegions(2);
				Data regionvotes1=rv1.readVoters(1);
				Data regionvotes2=rv2.readVoters(2);
