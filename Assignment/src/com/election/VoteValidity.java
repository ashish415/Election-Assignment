...
public class VoteValidity 
{
		...
		public void invalid2(String id,String votes,int count)	           //Store the Invalid Vote Condition 2 
		{
			...
			case 1:
				...
				System.out.println("xxxxxxxxInvalid Vote in Region1xxxxxxxx"+InvalidR1);
				break;
			case 2:
				InvalidR2.put(voter_id, votes_list);
				System.out.println("xxxxxxxxInvalid Vote in Region2xxxxxxxx"+InvalidR2);
				break;
			}
			
		}	
		
		public HashMap<Integer,String> Invalid3(HashMap<Integer, String> vr1, int count)				//Store the Invalid Vote Condition 3
		{
